...
{ !opened? <MobileHaznaka/>:
            <svg xmlns="http://www.w3.org/2000/svg" width="73" height="96" viewBox="0 0 73 96" className="app-icon" onClick={()=>setAppStarted(true)}>
                ...
                <text id="נכס_לאומי" data-name="נכס לאומי" transform="translate(0 91)" fill="#fff" font-size="17" font-family="Roboto-Regular, Roboto"><tspan x="0" y="0"> </tspan><tspan y="0" font-family="SegoeUI, Segoe UI">נכס לאומ</tspan></text>
            </svg>
}
        </div>
    )
